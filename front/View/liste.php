...
?>
<button onclick="generatePDF() class="btn btn-outline-primary btn-sm mb-0">Download </button>
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive p-0" id="invoice"
>
        ...
        ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <p class="text-xs text-secondary mb-0"> <?= $utilisateurs['email']; ?></p>
                      </td>
                      <td align="center">
                ...
                <td>
                    <a href="deleteutilisateurs.php?id=<?php echo $utilisateurs['id'];  ?>" class="btn btn-outline-primary btn-sm mb-0" >Delete</a>
        ...
        for($i=1;$i<=$pagesTotales;$i++){
            ...
            echo '<a href="liste.php?page='.$i.'" class="btn btn-outline-primary btn-sm mb-0">'.$i.'</a> ';
        }
    }
...
?>
  ...
  <script src="../back/assets/js/material-dashboard.min.js?v=3.0.0"></script>
</body>
